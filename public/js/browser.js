// i skided riptides code credit to nebula
...
if (web.contentWindow.location == window.location.protocol + "//" + window.location.hostname + "/browser/index.html") {
search.value = ""
seturl("/browser/index.html")
} else if (web.contentWindow.location == window.location.protocol + "//" + window.location.hostname + "/browser/about.html") {
...
if (search == "/browser/index.html" || search == "/pages/about") {
web.src = search
} else {
...
tab.className = "tab"
tab.setAttribute("url", "/browser/index.html")
